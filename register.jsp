...
<div class="" style="padding-top:200px;padding-bottom:100px;">
      ...
      <div class="panel-body" >
          <form class="form-horizontal form-signin" action="registered" onsubmit="return validate()" method="post"> 
	      ...
	      <select class="form-control" name="#" id="#" required>
	        ...
	        <b>Password</b><sup>*</sup><input type="password" class="form-control" id="pwd" name="#" placeholder="PASSWORD" required autofocus/>
	         	      
	      <b>Confirm Password</b><sup>*</sup><input type="password" class="form-control" id="cpwd" name="#" placeholder="RE-ENTER PASSWORD" required autofocus/>
